...
export default function () {
  return html`
    <section class="why-arrow" id="why">
      <p class="manifesto">
      ...
      <p>
        ...
        <code>component()</code> when you want stable local state. Need
        routing? The web platform already does this pretty well 😉.
      </p>
